<x-layout>
    ...
    @CSRF
        ...
        <div id ="Bottom half" class = "mt-25">
            <div id = DeliveryInfo class="flex-auto bg-base-300 p-2 rounded-xl ">
                <div class="card">
                    <div class="card-body">
                ...
                <div class="card">
                        <div class="card-body">
                            <h1 class = "text-2xl font-bold text-center mb-4">Payment Method</h1>
                                ...
                                <input type="hidden" name="Email_Address" id="hidden_Email_Address">
                                <input type="hidden" name="Phone_Number" id="hidden_Phone_Number">
                                <input type="hidden" name="Address_Line_1" id="hidden_Address_Line_1">
                                <input type="hidden" name="Address_Line_2" id="hidden_Address_Line_2">
                                <input type="hidden" name="City" id="hidden_City">
                                <input type="hidden" name="Postcode" id="hidden_Postcode">
                                <input type="hidden" name="Select_Country" id="hidden_Select_Country">
                                -->

                                <div class="flex justify-center mt-8">
                                    <button type="submit" class=" bg-black text-white px-8 py-2.5 rounded-xl shadow-md hover:bg-gray-900" on>Place Order</button>
                                </div>
                        </div>
                    </div>
                </div>
