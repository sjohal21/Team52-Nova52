...
<section class="max-w-6x1 auto px-4 py-12">
<div class="text-center mb-10">
    <h1 class="text-3x1 md:text-4x1 font-bold text-base-content">Privacy Policy</h1>
...
<div class="bg-base-200 rounded-2x1 p-6 md:p-8 border border-base-300 shadow-sm space-y-6 text-base-content/80">
    <div>
        <h2 class="text-lg font-bold text-base-content mb-2">1. What we collect </h2>
        <u1 class="list-disc ml-6 space-y-1">
...
<div>
    ...
    <p> If you have any quesitions about this privacy policy, please reach out via our contact page.
</p>
