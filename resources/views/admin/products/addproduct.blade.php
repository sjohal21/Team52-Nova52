<x-adminlayout>
    <x-slot:title>Add Products</x-slot:title>
                ...
                <div class = "bg-base-300 rounded-3xl px-8 py-10 shadow-sm"> 
                    ...
                    <!-- Centre Section Card -->
                        <div class="card-body text-center flex-1">    
                            <div id = "Title">
                                <h1 class="card-title font-bold justify-center text-3xl">Add Product</h1>
                            </div>
                            <div id = "Description">
                                <h4 class="font-bold justify-center">Create a new product into catalogue</h4>
                            </div>
                        </div>
